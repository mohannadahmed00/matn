 ...
 * `docs/PRODUCT-SPEC.md` § Navigation & App Shell). Only [LIBRARY] has a real screen today;
 * [GOALS]/[NOTES]/[SETTINGS] route to the shared [ComingSoonScreen] until Phases 6-8 land.
 */
